    ...
    return (  
        <div className='container'>
            <div className='row text-center  border-bottom'>
                <div className="col">
        <h1 style={{color:"rgb(72, 71, 71)"}} className='aboutpagehero  pb-5'>We pioneered the discount broking model in India.<br/>
        Now, we are breaking ground with our technology.</h1>
        <hr/>
        <div className='row mt-5 p-5 text-muted text-start' style={{lineHeight:'30px', fontSize:'1.1em'}}>
        <div className='col-6 '>
